<section class="account-deletion-section space-y-6">
    <header class="account-deletion-header">
    ...
    <x-danger-button
        ...
        class="account-deletion-button"
    >{{ __('Borrar Cuenta') }}</x-danger-button>

    <x-modal name="confirm-user-deletion" :show="$errors->userDeletion->isNotEmpty()" focusable>
        <form method="post" action="{{ route('profile.destroy') }}" class="account-deletion-modal p-6">
            @csrf
            @method('delete')
            ...
            <div class="mt-6">
                ...
                <x-text-input
                    ...
                    name="password"
                    type="password"
                    class="account-deletion-input mt-1 block w-3/4"
            ...
            <div class="mt-6 account-deletion-modal-buttons">
